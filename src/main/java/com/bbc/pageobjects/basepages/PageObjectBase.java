...
public abstract class PageObjectBase<TOriginPage> {
    ...
    public com.bbc.pageobjects.basepages.PageObjectBase<TOriginPage> OriginPage;

    SoftAssert softAssertion = new SoftAssert();

    public <D extends com.bbc.pageobjects.basepages.PageObjectBase<D>> D navigatingTo(Class<D> originPage) {
        D newPage = null;
        try {
